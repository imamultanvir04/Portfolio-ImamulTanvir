    ...
    <div  className="container">
     ...
     <div className="mt-20 flex flex-col gap-8">
      ...
      <Card className="h-[320px] md:col-span-3 lg:col-span-2">
        <CardHeader title="My Toolbox" description="Explore the technologies and tools I used ti craft exceptional digital experiences." 
        className=""/>
      ...
      <Card className="h-[320px] p-0 relative md:col-span-2 lg:col-span-1">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 size-20 rounded-full after:content-[''] after:absolute after:outline after:inset-0 after:outline after:outline-2 after:-outline-offset-2 after:rounded-full after:outline-gray-950/30">
