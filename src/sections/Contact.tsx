...
export const ContactSection = () => {
  return (
    ...
    <div className="py-16 pt-12 lg:py-24 lg:pt-20">
      ...
      <div className="">
     <a href="mailto:imamultanvir@gmail.com"> <button className="text-white bg-gray-900 inline-flex items-center px-6 h-12 rounded-xl gap-2 w-max border border-gray-900">
